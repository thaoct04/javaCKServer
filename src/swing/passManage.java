 ...
 * @author Admin
 */
public class passManage extends javax.swing.JFrame {

    static ServerSocket serverSocket;
    static Socket socket;
    static ObjectInputStream ist;
    static DefaultTableModel model;
    static Pet p;
    static ObjectOutputStream out;
    static myprocess pr;
    
    static ArrayList<Pet> list;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(passManage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new passManage().setVisible(true);
            }
        });
        ...
        try {
            ...
            list = (ArrayList<Pet>) ist.readObject();
            if (list != null) {
                System.out.println(list);
                model.setRowCount(0);
                for (Pet p : list) {
                    model.addRow(new Object[]{
                        p.getName(), p.getAge(), p.getSex(), p.getId(), p.getDate(), p.getCost()
                    });
                }
            }
